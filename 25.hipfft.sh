...
cd $ROCM_REL_DIR
wget https://github.com/ROCmSoftwarePlatform/hipFFT/archive/rocm-$PKGVER.tar.gz
tar xf hipFFT-$LDIR.tar.gz
rm -rf $ROCM_BUILD_DIR/hipfft
mkdir -p $ROCM_BUILD_DIR/hipfft
cd $ROCM_BUILD_DIR/hipfft

DEST=$OUTPUT/package-hipfft
PRGNAM=hipFFT
